...
class App extends Component{
    ...
    render(){
        ...
        const totalImporte = this.state.ordenes.reduce(function(acumulador,orden){
            return(acumulador+parseFloat(orden.importe)); 
        },0);  
                                    ...
                                    <div className="card-content">
                                       <h5>Resultados</h5>
                                        <div className="row">
                                            ...
                                            type="text"
                                            placeholder="SubTotal"
                                            value={total(totalImporte,iva(totalImporte))}
                                            />
                                            </div>
                                        </div>
                                     </div>
